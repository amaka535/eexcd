...
#customEmojis{overflow-y: scroll;max-height:140px;}
.unicodeemoji{filter: grayscale(30%);max-height:140px;float: left; width: 39.5px; padding: 1.5px; cursor: pointer;opacity: 0.8;transition-duration: 0.2s; }
